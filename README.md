...
| 端 | 说明 | 访问入口 |
|---|---|---|
| 学生端（前台门户） | 注册登录、个人信息与教育经历、岗位浏览与多条件筛选、一键投递、"我的投递"进度查看 | `http://localhost:5173` |
| HR 管理后台 | 岗位管理（含模板）、简历筛选与附件在线预览、数据报表、品牌配置、网络管理 | `http://localhost:5174/admin` |
| 系统管理端 | HR账号/角色/部门/字典/通知模板管理、操作审计、网络管理 | 与 HR 后台共入口 |
...
| 角色 | 地址 | 账号 | 密码 |
|---|---|---|---|
| HR 管理员 | `http://localhost:5174/admin` | `admin` | `admin123` |
| 学生 | `http://localhost:5173` | `18810121378` | `123456` |
